...
SRC_URI="https://github.com/logseq/og/releases/download/${PV}/Logseq-OG-linux-arm64-${PV}.zip -> ${P}.zip"
S="${WORKDIR}/Logseq-OG-linux-arm64"
...
src_prepare() {
	...
	# The ARM64 release contains unused x86-64 electron-deeplink build artifacts.
	# Linux uses the package's JavaScript stub and does not load the native module.
	rm -r resources/app/node_modules/electron-deeplink/{bin,build} || die
