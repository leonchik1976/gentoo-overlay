...
# directly inside the extracted AppImage for v0.74.2) accounts for all of
...
# empirically too: the v0.74.2 AppImage and every native .node addon and
...
# .so extracted from the real v0.74.2 AppImage (main binary, chrome-sandbox,
