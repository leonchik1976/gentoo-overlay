...
LICENSE="Apache-2.0"
# k3s's own go.mod lists 464 direct and indirect modules. The license
# set below was established for the previous release. The newly named
# google/nftables, pb33f/ordered-map/v2, and go-openapi/swag/pools modules
# are Apache-2.0 upstream. The cadvisor/lib module path and changed
# module versions were not exhaustively re-audited.
LICENSE+="
