...
# PARTIAL LICENSE AUDIT: the archive bundles 474 lib/*.jar dependencies.
# Compared with 26.7.3, all 281 embedded JAR LICENSE/NOTICE entries have
# identical paths and contents. JARs without one still need independent review.
#
...
#
# This is a large binary bundle that ships no aggregated third-party
# notice. The embedded META-INF/LICENSE and NOTICE texts were compared
# with the previous release; jars without one were not individually verified
# against their own upstream projects. Licenses found in that audit: the large
...
src_install() {
	...
	# upstream's enabled-by-default choice in 26.7.4 for backward
