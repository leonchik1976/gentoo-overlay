...
# RDEPEND checked with `readelf -d` against ELF binaries and .so files in
# the v4.8.0 amd64 AppImage; the arm64 dependency inventory still needs
# validation on gentoo. This includes Zettlr, chrome-sandbox,
