...
inherit go-module multiprocessing n8n-task-runners-pnpm-deps-2.35.7 python-single-r1 systemd
...
# go-module.eclass has deprecated EGO_SUM without a replacement.  Retain the
# existing source workflow because the official launcher binary cannot carry
# the loopback-only health-server patch applied below.
EGO_SUM=(
