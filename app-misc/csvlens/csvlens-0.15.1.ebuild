...
src_test() {
	...
	# Requires a running X11 or Wayland clipboard service when clipboard is
	# enabled, and expects clipboard success even when the feature is disabled.
	CARGO_SKIP_TESTS+=( app::tests::test_copy_selection_crlf )
	cargo_src_test
}
