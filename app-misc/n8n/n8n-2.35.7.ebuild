...
inherit check-reqs multiprocessing n8n-pnpm-deps-2.35.7 python-any-r1 systemd wrapper
...
PATCHES=(
	# The offline-deploy patch remains unchanged; the ripgrep patch has
	# version-specific context for upstream's expanded dependency list.
	"${FILESDIR}/n8n-2.35.7-system-ripgrep.patch"
