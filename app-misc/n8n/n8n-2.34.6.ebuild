...
inherit check-reqs multiprocessing n8n-pnpm-deps-2.34.6 python-any-r1 systemd wrapper
...
PATCHES=(
	# Reuse the 2.34.5-named patches because their targeted code and patch
	# contexts are unchanged in 2.34.6; this avoids duplicate FILESDIR files.
	"${FILESDIR}/n8n-2.34.5-system-ripgrep.patch"
	"${FILESDIR}/n8n-2.34.5-offline-direct-deps.patch"
)
