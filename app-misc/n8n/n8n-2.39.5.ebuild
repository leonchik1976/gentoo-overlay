...
LICENSE="
	...
	|| ( MIT GPL-3+ )
	|| ( MIT WTFPL-2 )
	0BSD Apache-2.0 BlueOak-1.0.0 BSD-2 BSD ISC MIT MIT-0 PSF-2 Unlicense
"
SLOT="0"
...
src_configure() {
	...
	export pnpm_config_offline=true npm_config_offline=true
	...
	isolated_dir=node_modules/.pnpm/isolated-vm@7.0.1/node_modules/isolated-vm
	sqlite_dir=packages/cli/node_modules/sqlite3
...
src_compile() {
	...
	for package in isolated-vm@7.0.1 sqlite3@5.1.7 @parcel+watcher@2.5.1; do
		...
		[[ ${package_name} == sqlite3 ]] && source_native=packages/cli/node_modules/sqlite3
	...
	rm -rf compiled/node_modules/.pnpm/isolated-vm@7.0.1/node_modules/isolated-vm/prebuilds || die
	...
	find compiled/node_modules/.pnpm \
		\( -path '*/@sentry-internal/node-cpu-profiler/lib/*.node' -o \
