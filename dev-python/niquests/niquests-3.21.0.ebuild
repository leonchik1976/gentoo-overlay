...
DESCRIPTION="HTTP client with synchronous and asynchronous APIs"
HOMEPAGE="
...
# Upstream's full suite requires several web frameworks and a local test
# server.  Keep a basic installed-module check without pulling those stacks.
