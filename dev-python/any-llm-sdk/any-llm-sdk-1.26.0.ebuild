...
RDEPEND="
	...
	>=dev-python/openai-2.18.0[${PYTHON_USEDEP}]
	<dev-python/openresponses-types-3[${PYTHON_USEDEP}]
	>=dev-python/openresponses-types-2.4.0[${PYTHON_USEDEP}]
...
pkg_postinst() {
	...
	optfeature "Together provider support" ">=dev-python/together-2.0.0"
	...
	optfeature "Otari provider support" ">=dev-python/otari-0.3.0"
}
