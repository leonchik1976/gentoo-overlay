...
# https://pypi.org/pypi/semgrep/1.174.0/json (verified against the
...
SRC_URI="
	amd64? (
		https://files.pythonhosted.org/packages/f9/1d/e1fd6313ecd860b2983456b2b20b7efe4cd7f301eafaaca7a765c7049afa/semgrep-${PV}-cp310.cp311.cp312.cp313.cp314.py310.py311.py312.py313.py314-none-manylinux_2_34_x86_64.whl
	)
	arm64? (
		https://files.pythonhosted.org/packages/7d/db/5a9f87de501e31900d2eb0cb32b26bf86380242dc90f54685b194b07acac/semgrep-${PV}-cp310.cp311.cp312.cp313.cp314.py310.py311.py312.py313.py314-none-manylinux_2_34_aarch64.whl
	)
"
S="${WORKDIR}"
...
# (see dev-util/semgrep-bin-1.174.0's PyPI METADATA), preserving
