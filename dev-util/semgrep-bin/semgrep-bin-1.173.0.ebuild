...
# https://pypi.org/pypi/semgrep/1.173.0/json (verified against the
...
SRC_URI="
	amd64? (
		https://files.pythonhosted.org/packages/32/ea/dbcdc05e4954be743f8f87a8feb41eabd3a2d13bd34687bfaae864a2c315/semgrep-${PV}-cp310.cp311.cp312.cp313.cp314.py310.py311.py312.py313.py314-none-manylinux_2_34_x86_64.whl
	)
	arm64? (
		https://files.pythonhosted.org/packages/7d/f8/aa43bff34d593476ceee8c2f982f3b60aa9f6029065585022201be795e23/semgrep-${PV}-cp310.cp311.cp312.cp313.cp314.py310.py311.py312.py313.py314-none-manylinux_2_34_aarch64.whl
	)
"
S="${WORKDIR}"
...
# (see dev-util/semgrep-bin-1.173.0's PyPI METADATA), preserving
