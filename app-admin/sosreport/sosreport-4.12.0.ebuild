...
python_test() {
	# The remaining suites are Avocado-based system/integration tests which
	# create reports and exercise the host rather than the isolated build tree.
	epytest tests/unittests
}
