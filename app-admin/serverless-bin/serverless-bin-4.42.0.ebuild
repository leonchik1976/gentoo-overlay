...
# Install upstream's versioned distribution directly, without its networked
# npm installer stub or install.sh launcher.
...
# (cpu-features/ssh2) that fall back gracefully when absent/foreign-arch, as in the previous
# release; native arm64 validation for this release is reported separately.
QA_PREBUILT="
