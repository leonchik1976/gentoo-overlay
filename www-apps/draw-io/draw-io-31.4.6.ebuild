...
# Audited across the whole built WAR (src/main/webapp tree + the WEB-INF/lib
# jars) for v31.4.4; the 31.4.6 source archive has the same WAR library
# filenames and six identical LICENSE files as 31.4.5. Other bundled
# assets were not independently re-audited:
...
PATCHES=( "${FILESDIR}/${PN}-31.4.4-javac-release-8.patch" )
